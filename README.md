# [СЕКТА РАЕВСКОГО] «Школа Дмитрия Раевского» = «Клиника Раевского» = лжегуру Глеб_Александров = ДЕСТРУКТИВНАЯ СЕКТА РАЕВСКОГО!
...
## ЦЕЛЫЙ САЙТ С РАЗОБЛАЧЕНИЯМИ И ПОСЛЕДНЯЯ ВЕРСИЯ КНИГИ НАХОДЯТСЯ ПО АДРЕСУ -- 
